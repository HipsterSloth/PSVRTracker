...
IF(NOT OpenCV_DIR)
    IF(${CMAKE_SYSTEM_NAME} MATCHES "Windows")
        ...
        set(OpenCV_INCLUDE_DIRS ${ROOT_DIR}/deps/local/include)
				...
				elseif(1910 EQUAL MSVC_VERSION)
					if(CMAKE_C_SIZEOF_DATA_PTR EQUAL 8)
						set(OPENCV_LIBS_DIR ${ROOT_DIR}/deps/local/x64/vc15/staticlib)
					else()
						set(OPENCV_LIBS_DIR ${ROOT_DIR}/deps/local/x86/vc15/staticlib)
					endif()
				else()
