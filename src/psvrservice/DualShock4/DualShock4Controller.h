...
class DualShock4ControllerConfig : public PSVRConfig
{
public:
    static const int CONFIG_VERSION;

    DualShock4ControllerConfig(const std::string &fnamebase = "PSDualShock4ControllerConfig")
		...
		, hand("Any")
    {
		...
		accelerometer_gain.x = 1.f / 512.f;
		accelerometer_gain.y = 1.f / 512.f;
		accelerometer_gain.z = 1.f / 512.f;
        ...
        accelerometer_bias.x = 0.f;
        accelerometer_bias.y = 0.f;
        accelerometer_bias.z = 0.f;
        ...
        identity_gravity_direction.y= cosf(ACCELEROMETER_IDENTITY_PITCH_DEGREES*k_degrees_to_radians);
        identity_gravity_direction.z= -sinf(ACCELEROMETER_IDENTITY_PITCH_DEGREES*k_degrees_to_radians);
    };
    ...
    PSVRVector3f accelerometer_bias;
...
struct DualShock4ControllerInputState : public CommonControllerState
{
    ...
    PSVRButtonState DPad_Up;
    PSVRButtonState DPad_Down;
    PSVRButtonState DPad_Left;
    PSVRButtonState DPad_Right;
    ...
    PSVRButtonState Share;
    PSVRButtonState Options;
    ...
    PSVRVector3f CalibratedAccelerometer; // units of g (where 1g = 9.8m/s^2)
    PSVRVector3f CalibratedGyro; // rad/s
...
public:
    ...
    {
        return CommonSensorState::DualShock4;
    }
    ...
    // -- Getters
    inline const DualShock4ControllerConfig *getConfig() const
    {
        return &cfg;
    }
