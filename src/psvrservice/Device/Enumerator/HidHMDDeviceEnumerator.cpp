...
std::string HidHMDDeviceEnumerator::get_interface_path(int interface_number) const
{
	std::string path = "";
...
void HidHMDDeviceEnumerator::build_interface_list()
{
	...
	if (devs != nullptr)
	{
		...
		{
			HidHMDDeviceInterface hmd_interface;
