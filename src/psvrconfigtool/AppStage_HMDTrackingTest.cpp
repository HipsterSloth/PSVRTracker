...
AppStage_HMDTrackingTest::~AppStage_HMDTrackingTest()
{
    delete m_pCalibrateWithMat;
}

void AppStage_HMDTrackingTest::enterStageAndCalibrateTrackersWithController(App *app, PSMControllerID reqeusted_controller_id)
{
...
void AppStage_HMDTrackingTest::enterStageAndCalibrateTrackersWithHMD(class App *app, PSMHmdID reqeusted_hmd_id)
{
    AppStage_HMDTrackingTest *appStage = app->getAppStage<AppStage_HMDTrackingTest>();
    appStage->m_bSkipCalibration = false;
...
void AppStage_HMDTrackingTest::enterStageAndTestTrackers(App *app, PSMControllerID reqeusted_controller_id, PSMHmdID requested_hmd_id)
{
    AppStage_HMDTrackingTest *appStage = app->getAppStage<AppStage_HMDTrackingTest>();
    ...
    case eMenuState::calibrateWithMat:
        {
            ...
            {
                setState(AppStage_HMDTrackingTest::eMenuState::testTracking);
            }
            else if (m_pCalibrateWithMat->getMenuState() == AppSubStage_CalibrateWithMat::calibrateStepFailed)
            {
                setState(AppStage_HMDTrackingTest::eMenuState::calibrateStepFailed);
            }
        }
        break;
...
void AppStage_HMDTrackingTest::go_next_tracker()
{
...
void AppStage_HMDTrackingTest::go_previous_tracker()
{
    const int trackerCount = static_cast<int>(m_trackerViews.size());
...
int AppStage_HMDTrackingTest::get_tracker_count() const
{
    return static_cast<int>(m_trackerViews.size());
}

int AppStage_HMDTrackingTest::get_render_tracker_index() const
{
    return m_renderTrackerIndex;
}

PSMTracker *AppStage_HMDTrackingTest::get_render_tracker_view() const
{
    return (m_trackerViews.size() > 0) ? m_renderTrackerIter->second.trackerView : nullptr;
}

PSMController *AppStage_HMDTrackingTest::get_calibration_controller_view() const
{
    return (m_controllerViews.size() > 0) ? m_controllerViews.begin()->second.controllerView : nullptr;
}

PSMHeadMountedDisplay *AppStage_HMDTrackingTest::get_calibration_hmd_view() const
{
...
void AppStage_HMDTrackingTest::request_controller_list()
{
    if (m_menuState != AppStage_HMDTrackingTest::pendingControllerListRequest)
    {
        m_menuState = AppStage_HMDTrackingTest::pendingControllerListRequest;
        
        // Request a list of controllers back from the server
        PSMRequestID requestID;
        PSM_GetControllerListAsync(&requestID);
        PSM_RegisterCallback(requestID, AppStage_HMDTrackingTest::handle_controller_list_response, this);
    }
}

void AppStage_HMDTrackingTest::handle_controller_list_response(
    ...
    void *userdata)
{
    ...
    AppStage_HMDTrackingTest *thisPtr = static_cast<AppStage_HMDTrackingTest *>(userdata);
    ...
    case PSMResult_Success:
        {
            ...
            if (thisPtr->m_overrideControllerId == -1)
            {
                ...
                {
                    thisPtr->setState(AppStage_HMDTrackingTest::failedControllerListRequest);
                }
            }
            else
            {
...
void AppStage_HMDTrackingTest::request_start_controller_stream(
    int ControllerID,
    int listIndex,
    PSMTrackingColorType trackingColorType)
{
    ...
    // Start receiving data from the controller
    {
        ...
        PSM_RegisterCallback(request_id, &AppStage_HMDTrackingTest::handle_start_controller_response, this);
    }
}

void AppStage_HMDTrackingTest::handle_start_controller_response(
    const PSMResponseMessage *response_message,
    void *userdata)
{
    AppStage_HMDTrackingTest *thisPtr = static_cast<AppStage_HMDTrackingTest *>(userdata);
    ...
    case PSMResult_Timeout:
        {
            thisPtr->setState(AppStage_HMDTrackingTest::failedControllerStartRequest);
        } break;
    }
}
...
void AppStage_HMDTrackingTest::request_hmd_list()
{
    if (m_menuState != AppStage_HMDTrackingTest::pendingHmdListRequest)
    {
        ...
        PSM_RegisterCallback(requestID, AppStage_HMDTrackingTest::handle_hmd_list_response, this);
    }
}
    ...
    case PSMResult_Success:
        {
            ...
            else
            {
                ...
                {
                    thisPtr->setState(AppStage_HMDTrackingTest::failedHmdListRequest);
                }
            }
        } break;
    ...
    PSMTrackingColorType trackingColorType)
{
    ...
    // Start receiving data from the controller
    {
        ...
        PSM_RegisterCallback(request_id, &AppStage_HMDTrackingTest::handle_start_hmd_response, this);
    }
}
    ...
    void *userdata)
{
    ...
    case PSMResult_Timeout:
        {
            thisPtr->setState(AppStage_HMDTrackingTest::failedHmdStartRequest);
        } break;
    }
}
...
void AppStage_HMDTrackingTest::request_tracker_list()
{
    if (m_menuState != eMenuState::pendingTrackerListRequest)
    {
        ...
        PSM_RegisterCallback(requestId, AppStage_HMDTrackingTest::handle_tracker_list_response, this);
    }
}
    ...
    int listIndex)
{
    ...
    PSM_StartTrackerDataStreamAsync(
        ...
        &requestID);
    PSM_RegisterCallback(requestID, AppStage_HMDTrackingTest::handle_tracker_start_stream_response, this);
}
...
void AppStage_HMDTrackingTest::request_set_tracker_pose(
    const PSMPosef *pose,
...
bool AppStage_HMDTrackingTest::does_tracker_see_any_device(const PSMTracker *trackerView)
{
    return does_tracker_see_any_controller(trackerView) || does_tracker_see_any_hmd(trackerView);
}

bool AppStage_HMDTrackingTest::does_tracker_see_any_controller(const PSMTracker *trackerView)
{
...
bool AppStage_HMDTrackingTest::does_tracker_see_any_hmd(const PSMTracker *trackerView)
{
